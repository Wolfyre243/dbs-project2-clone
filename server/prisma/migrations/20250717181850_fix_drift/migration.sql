...
*/
-- AlterTable
ALTER TABLE "audio" ADD COLUMN     "file_name" VARCHAR(150) NOT NULL,
ALTER COLUMN "description" DROP NOT NULL;

-- AlterTable
ALTER TABLE "audit_action" ALTER COLUMN "description" DROP NOT NULL;

-- AlterTable
ALTER TABLE "exhibit" ALTER COLUMN "description" DROP NOT NULL;

-- AlterTable
ALTER TABLE "image" ADD COLUMN     "file_name" VARCHAR(150) NOT NULL,
ALTER COLUMN "description" DROP NOT NULL;
