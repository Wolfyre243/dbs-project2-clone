...
module.exports.generateQRCode = async (createdBy, exhibitId, ipAddress) => {
...
module.exports.archiveQRCode = async (qrCodeId, userId, ipAddress) => {
  try {
   ...
   await require('./imageModel').archiveImage(qrCode.imageId, statusCodes.ARCHIVED);
